...
<div class="row align-items-center py-4">
    ...
    <div class="col-lg-4 col-5 text-right">
        <a href="{{ route('evaluasiTrens.index') }}" class="btn btn-danger">Kembali</a>
    </div>
</div>
@endsection
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-sm-12 mb-3">
                    @include('evaluasi_trens.table_alokasi')
                </div>
                <div class="col-sm-12 mb-3">
                    <h5>B. Penyaluran Transfer ke Daerah</h5>
                </div>
                <!-- <div class="col-sm-3 mb-2">
                    <a class="btn btn-primary float-right" href="{{ url('evaluasiPenyalurans/'.$pemda->id.'/'.$pemda->tahun.'/create') }}">
                        + Penyaluran
                    </a>
                </div> -->
                <div class="col-sm-12 mb-3">
                    @include('evaluasi_trens.table_penyaluran')
                ...
                <!-- <div class="col-sm-3 mb-2">
                    <a class="btn btn-primary float-right" href="{{ url('evaluasiPenggunaans/'.$pemda->id.'/'.$pemda->tahun.'/create') }}">
                        + Penggunaan
                    </a>
                </div> -->
                <div class="col-sm-12 mb-3">
                    @include('evaluasi_trens.table_penggunaan')
