        ...
        <table id="permasalahanPelaksanaan" class="table text-center m-0">
            ...
            <tbody>
                <tr>
                    ...
                    <td>{!! Form::number('masalah1', null, ['class' => 'form-control', 'step' => '0.01', 'required']) !!}</td>
                ...
                <tr>
                    ...
                    <td>{!! Form::number('masalah2', null, ['class' => 'form-control', 'step' => '0.01', 'required']) !!}</td>
                    <td>{!! Form::textarea('uraian_masalah2', null, ['class' => 'form-control', 'rows' => '3']) !!}</td>
                </tr>
                <tr>
                    <td>P3</td>
                    <td>Kekurangan volume pekerjaan</td>
                    <td>{!! Form::number('masalah3', null, ['class' => 'form-control', 'step' => '0.01', 'required']) !!}</td>
                ...
                <tr>
                    ...
                    <td>{!! Form::number('masalah4', null, ['class' => 'form-control', 'step' => '0.01', 'required']) !!}</td>
                ...
                <tr>
                    ...
                    <td>{!! Form::number('masalah5', null, ['class' => 'form-control', 'step' => '0.01', 'required']) !!}</td>
                ...
                <tr>
                    ...
                    <td>{!! Form::number('masalah6', null, ['class' => 'form-control', 'step' => '0.01', 'required']) !!}</td>
                ...
                <tr>
                    ...
                    <td>{!! Form::number('masalah7', null, ['class' => 'form-control', 'step' => '0.01', 'required']) !!}</td>
                    <td>{!! Form::textarea('uraian_masalah7', null, ['class' => 'form-control', 'rows' => '3']) !!}</td>
                </tr>
                <tr>
                    <td>P8</td>
                    <td>Permasalahan Lainnya</td>
                    <td>{!! Form::number('masalah8', null, ['class' => 'form-control', 'step' => '0.01', 'required']) !!}</td>
        ...
        <table id="permasalahanPemanfaatan" class="table text-center m-0">
            ...
            <tbody>
                <tr>
                    ...
                    <td>{!! Form::number('manfaat1', null, ['class' => 'form-control', 'step' => '0.01', 'required']) !!}</td>
                ...
                <tr>
                    ...
                    <td>{!! Form::number('manfaat2', null, ['class' => 'form-control', 'step' => '0.01', 'required']) !!}</td>
                ...
                <tr>
                    ...
                    <td>{!! Form::number('manfaat3', null, ['class' => 'form-control', 'step' => '0.01', 'required']) !!}</td>
                ...
                <tr>
                    ...
                    <td>{!! Form::number('manfaat4', null, ['class' => 'form-control', 'step' => '0.01', 'required']) !!}</td>
                    <td>{!! Form::textarea('uraian_manfaat4', null, ['class' => 'form-control', 'rows' => '3']) !!}</td>
                </tr>
                <tr>
                    <td>M5</td>
                    <td>Hasil pekerjaan masih dalam sengketa</td>
                    <td>{!! Form::number('manfaat5', null, ['class' => 'form-control', 'step' => '0.01', 'required']) !!}</td>
                ...
                <tr>
                    ...
                    <td>{!! Form::number('manfaat6', null, ['class' => 'form-control', 'step' => '0.01', 'required']) !!}</td>
                ...
                <tr>
                    ...
                    <td>{!! Form::number('manfaat7', null, ['class' => 'form-control', 'step' => '0.01', 'required']) !!}</td>
                    <td>{!! Form::textarea('uraian_manfaat7', null, ['class' => 'form-control', 'rows' => '3']) !!}</td>
                </tr>
                <tr>
                    <td>M8</td>
                    <td>Lainnya</td>
                    <td>{!! Form::number('manfaat8', null, ['class' => 'form-control', 'step' => '0.01', 'required']) !!}</td>
