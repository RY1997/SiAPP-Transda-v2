...
<div class="row align-items-center py-4">
    ...
    <div class="col-lg-4 col-5 text-right">
        <a href="{{ url('evaluasiPrioritas/create?st='.$suratTugas->id.'&tahun='.$tahun) }}" class="btn btn-success">Tambah Kegiatan</a>
        <a href="{{ route('evaluasiPrioritas.index') }}" class="btn btn-danger">Kembali</a>
    </div>
</div>
@endsection
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-sm-12 mb-3">
                    @include('evaluasi_prioritas.show_table')
                </div>
            </div>
        </div>
    </div>
