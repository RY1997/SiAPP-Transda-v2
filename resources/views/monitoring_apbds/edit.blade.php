...
<div class="d-md-flex align-items-center justify-content-between mb-7">
    <div class="mb-4 mb-md-0">
        <h4 class="fs-6 mb-0">Ubah Rincian APBD</h4>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item">
                    <a class="text-primary text-decoration-none" href="{{ route('monitoringApbds.index') }}">Rincian APBD</a>
                </li>
    ...
    <div class="d-flex align-items-center justify-content-between gap-6">
        <a href="{{ route('monitoringApbds.index') }}" class="btn btn-danger d-flex align-items-center gap-1 fs-3 py-2 px-9">
...
<div class="content">
    ...
    <div class="card">
        ...
        <div class="card-footer d-flex justify-content-end">
            ...
            <a href="{{ route('monitoringApbds.index') }}" class="btn btn-danger mx-1">Batal</a>
        </div>
