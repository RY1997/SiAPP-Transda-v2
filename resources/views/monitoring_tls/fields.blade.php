...
<div class="form-group col-sm-9 mb-3">
    {!! Form::text('kelompok_permasalahan', null, ['class' => 'form-control bg-light','maxlength' => 255,'maxlength' => 255, 'readonly']) !!}
</div>
...
<div class="form-group col-sm-9 mb-3">
    {!! Form::number('nilai_permasalahan', null, ['class' => 'form-control bg-light', 'step' => '0.01', 'readonly']) !!}
</div> -->
