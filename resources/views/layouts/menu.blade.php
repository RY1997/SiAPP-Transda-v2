...
<li class="nav-item">
    <a href="{{ route('rippOtsuses.index') }}"
       class="nav-link {{ Request::is('rippOtsuses*') ? 'active' : '' }}">
        <p>Ripp Otsuses</p>
    </a>
</li>
...
<li class="nav-item">
    <a href="{{ route('silpaOtsuses.index') }}"
       class="nav-link {{ Request::is('silpaOtsuses*') ? 'active' : '' }}">
        <p>Silpa Otsuses</p>
    </a>
</li>
...
<li class="nav-item">
    <a href="{{ route('suratTugas.index') }}"
       class="nav-link {{ Request::is('suratTugas*') ? 'active' : '' }}">
        <p>Surat Tugas</p>
    </a>
</li>
...
<li class="nav-item">
    <a href="{{ route('pelaporans.index') }}"
       class="nav-link {{ Request::is('pelaporans*') ? 'active' : '' }}">
        <p>Pelaporans</p>
    </a>
</li>
