    ...
    <table class="table text-center m-0" id="monitoringAlokasis-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-right">{{ number_format($monitoringTren->penggunaan_sum_anggaran_barjas + $monitoringTren->penggunaan_sum_anggaran_pegawai + $monitoringTren->penggunaan_sum_anggaran_modal + $monitoringTren->penggunaan_sum_anggaran_hibah + $monitoringTren->penggunaan_sum_anggaran_lainnya + $monitoringTren->penggunaan_sum_anggaran_na, 2, ',', '.') }}</td>
                <td class="text-right">{{ number_format($monitoringTren->penggunaan_sum_realisasi_barjas + $monitoringTren->penggunaan_sum_realisasi_pegawai + $monitoringTren->penggunaan_sum_realisasi_modal + $monitoringTren->penggunaan_sum_realisasi_hibah + $monitoringTren->penggunaan_sum_realisasi_lainnya + $monitoringTren->penggunaan_sum_realisasi_na, 2, ',', '.') }}</td>
                <td width="120">
                    <div class='btn-group'>
