...
@push('page_title')
Evaluasi Kebutuhan dan Pendanaan
@endpush
    ...
    <div class="col-lg-8 col-7">
        <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
            <ol class="breadcrumb breadcrumb-links breadcrumb-dark bg-white">
                ...
                <li class="breadcrumb-item active" aria-current="page">Kebutuhan & Pendanaan</li>
            </ol>
        </nav>
    </div>
    <div class="col-lg-4 col-5 text-right">
        <a class="btn btn-default float-right"
            href="{{ route('evaluasiKebutuhans.create') }}">
            Tambah
        </a>
...
<div class="content">
    ...
    <div class="card">
        <div class="card-body p-0">
            @include('evaluasi_kebutuhans.table')
        </div>
    </div>
</div>
@endsection