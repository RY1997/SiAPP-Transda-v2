    ...
    <table class="table text-center m-0" id="monitoringPenggunaans-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $monitoringPenggunaans->where('nama_pemda', $daftarPemda->nama_pemda)->where('tahun', $tahun)->where('jenis_tkd', 'Otsus')->sum('penggunaan_tkd') }}</td>
                <td>{{ $monitoringPenggunaans->where('nama_pemda', $daftarPemda->nama_pemda)->where('tahun', $tahun)->where('jenis_tkd', 'DTI')->sum('penggunaan_tkd') }}</td>
                <td>{{ $monitoringPenggunaans->where('nama_pemda', $daftarPemda->nama_pemda)->where('tahun', $tahun)->where('jenis_tkd', 'DAU')->sum('penggunaan_tkd') }}</td>
                <td>{{ $monitoringPenggunaans->where('nama_pemda', $daftarPemda->nama_pemda)->where('tahun', $tahun)->where('jenis_tkd', 'DAK')->sum('penggunaan_tkd') }}</td>
                ...
                <td width="120">
                    <div class='btn-group'>
                        <a href="{{ url('monitoringPenggunaans/'.$daftarPemda->id.'/'.$tahun) }}" class='btn btn-sm btn-warning'>
