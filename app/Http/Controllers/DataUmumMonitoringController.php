...
class DataUmumMonitoringController extends AppBaseController
{
    ...
    {
        $dataUmumTkds = DataUmumTkd::where('jenis_tkd', session('jenis_tkd'))->where('nama_pemda', 'like', '%' . $request->nama_pemda . '%');
        ...
        return view('data_umum_monitorings.index')
            ->with([
                'dataUmumTkds' => $dataUmumTkds,
    ...
    public function store(CreateDataUmumTkdRequest $request)
    {
        ...
        return redirect(route('monitoringDataUmumTkds.index'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('data_umum_monitorings.edit')->with([
            'dataUmumTkds' => $dataUmumTkds,
        ]);
    }
