 ...
 */
class EvaluasiNonfisik extends Model
{

    use HasFactory;

    public $table = 'eva_nonfisik';
    ...
    protected $casts = [
        ...
        'no_bast' => 'string',
        'tgl_bast' => 'date',
        'realisasi_bast' => 'integer',
        'persen_fisik' => 'decimal:2',
        ...
        'fisik_omspan' => 'decimal:2',
        'fisik_auditor' => 'decimal:2',
    ...
    public static $rules = [
        ...
        'tanggal_kontrak' => 'nullable',
        'uraian_kontrak' => 'nullable|string',
        ...
        'sisa_nilai_kontrak' => 'nullable|numeric',
        ...
        'fisik_omspan' => 'nullable|numeric',
        'fisik_auditor' => 'nullable|numeric',
