...
class EvaluasiKontrak extends Migration
{
    ...
    public function up()
    {
        Schema::create('eva_kontrak', function (Blueprint $table) {
            ...
            $table->text('jenis_kontrak')->nullable();
            $table->text('lokasi');
            $table->text('nama_opd')->nullable();
            $table->text('nama_rekanan')->nullable();
            $table->text('tgl_lelang')->nullable();
            ...
            $table->text('no_bast')->nullable();
            $table->date('tgl_bast')->nullable();
            $table->text('realisasi_bast')->nullable();
            $table->text('persen_fisik')->nullable();
